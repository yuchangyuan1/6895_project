...
```cmd
cd /d "D:\yuchangyuan\Documents\6895_project"
python -m demo.app
```
...
* **P95 Latency:** **22.3 ms** (steady-state; first call includes BGE-small model loading)
...
| :--- | :---: | :---: | :---: |
| **Safe/Clean** | 1.00 | 0.13 | 0.24 |
| **Risky/Flagged** | 0.73 | 1.00 | 0.84 |
...
**Methodology:** Utilized DeepSeek-V3 as an independent judge to grade (scale 1–10) 15 randomly sampled agent responses from the 100-prompt benchmark, based on empathy, clinical accuracy, and safety criteria.
